<?php
    ...
    function aplicarDescuentoManga()
    {
        ...
        //Utilizamos un foreach para recorrer todo el inventario de comics. Por cada comic con el idioma "Japonés" le aplicamos el descuento en cuestión.
        foreach ($inventario as $categoria => &$comics) 
        {
            foreach ($comics as &$comic) 
            {
                ...
                {
                    $comic['precio'] = $comic['precio'] * 0.7; // Aplicamos un descuento del 30%
                }
            }
        }
    }
